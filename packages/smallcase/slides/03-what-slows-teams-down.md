...
<div class="grid grid-cols-2 gap-6 mt-12">
  <div v-click class="p-6 rounded-xl bg-red-500/10 border border-red-500/30">
    ...
    <div class="text-sm opacity-70">Adding a simple feature requires touching 6+ files across unrelated directories</div>
  </div>

  <div v-click class="p-6 rounded-xl bg-red-500/10 border border-red-500/30">
    <div class="i-carbon-warning-alt text-3xl text-red-400 mb-4"></div>
    <div class="text-lg font-semibold text-red-300 mb-2">Regression Risk</div>
    <div class="text-sm opacity-70">Changing one thing breaks three others — everything is tightly coupled</div>
  </div>
